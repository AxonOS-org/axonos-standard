# Medium Source Packet #30: AxonOS Article #30: Riemannian Geometry for BCI Transfer — Source Intake
...
| Packet number | 30 |
| Working title | AxonOS Article #30: Riemannian Geometry for BCI Transfer — Source Intake |
| Normative status | Non-normative |
| Primary AOS route | AOS-0007, AOS-0010 |
...
For packet #30, the governing principle is that narrative claims must be
...
```text
source_packet: medium-30
source_title: AxonOS Article #30: Riemannian Geometry for BCI Transfer — Source Intake
target_aos: AOS-0007, AOS-0010
claim:
evidence_level:
artifact:
limitations:
...
Packet #30, `AxonOS Article #30: Riemannian Geometry for BCI Transfer — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #30
Source: standard/sources/medium/articles/30-*.md
Target AOS: AOS-0007, AOS-0010
Claim:
Evidence level:
