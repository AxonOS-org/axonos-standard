# Medium Source Packet #08: AxonOS Article #8: Consent as Runtime State — Source Intake
...
| Packet number | 08 |
| Working title | AxonOS Article #8: Consent as Runtime State — Source Intake |
...
For packet #08, the governing principle is that narrative claims must be
...
```text
source_packet: medium-08
source_title: AxonOS Article #8: Consent as Runtime State — Source Intake
...
Packet #08, `AxonOS Article #8: Consent as Runtime State — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #08
Source: standard/sources/medium/articles/08-*.md
