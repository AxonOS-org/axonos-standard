# Medium Source Packet #20: AxonOS Article #20: The BCI Gateway Boundary — Source Intake
...
| Packet number | 20 |
| Working title | AxonOS Article #20: The BCI Gateway Boundary — Source Intake |
...
For packet #20, the governing principle is that narrative claims must be
...
```text
source_packet: medium-20
source_title: AxonOS Article #20: The BCI Gateway Boundary — Source Intake
...
Packet #20, `AxonOS Article #20: The BCI Gateway Boundary — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #20
Source: standard/sources/medium/articles/20-*.md
