# Medium Source Packet #15: AxonOS Article #15: No Raw Neural Data by Default — Source Intake
...
| Packet number | 15 |
| Working title | AxonOS Article #15: No Raw Neural Data by Default — Source Intake |
| Normative status | Non-normative |
| Primary AOS route | AOS-0001, AOS-0004 |
...
For packet #15, the governing principle is that narrative claims must be
...
```text
source_packet: medium-15
source_title: AxonOS Article #15: No Raw Neural Data by Default — Source Intake
target_aos: AOS-0001, AOS-0004
claim:
evidence_level:
artifact:
limitations:
...
Packet #15, `AxonOS Article #15: No Raw Neural Data by Default — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #15
Source: standard/sources/medium/articles/15-*.md
Target AOS: AOS-0001, AOS-0004
Claim:
Evidence level:
