# Medium Source Packet #07: AxonOS Article #7: Neural Permissions — Source Intake
...
| Packet number | 07 |
| Working title | AxonOS Article #7: Neural Permissions — Source Intake |
...
For packet #07, the governing principle is that narrative claims must be
...
```text
source_packet: medium-07
source_title: AxonOS Article #7: Neural Permissions — Source Intake
...
Packet #07, `AxonOS Article #7: Neural Permissions — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #07
Source: standard/sources/medium/articles/07-*.md
