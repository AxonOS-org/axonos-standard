# Medium Source Packet #40: AxonOS Article #40: Conformance Profiles for BCI Software — Source Intake
...
| Packet number | 40 |
| Working title | AxonOS Article #40: Conformance Profiles for BCI Software — Source Intake |
| Normative status | Non-normative |
| Primary AOS route | AOS-0006 |
...
For packet #40, the governing principle is that narrative claims must be
...
```text
source_packet: medium-40
source_title: AxonOS Article #40: Conformance Profiles for BCI Software — Source Intake
target_aos: AOS-0006
claim:
evidence_level:
artifact:
...
Packet #40, `AxonOS Article #40: Conformance Profiles for BCI Software — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #40
Source: standard/sources/medium/articles/40-*.md
Target AOS: AOS-0006
Claim:
Evidence level:
