# Medium Source Packet #42: AxonOS Article #42: Toward an Industry Standard for BCI Software — Source Intake
...
| Packet number | 42 |
| Working title | AxonOS Article #42: Toward an Industry Standard for BCI Software — Source Intake |
| Normative status | Non-normative |
| Primary AOS route | AOS-0000, AOS-0011 |
...
For packet #42, the governing principle is that narrative claims must be
...
```text
source_packet: medium-42
source_title: AxonOS Article #42: Toward an Industry Standard for BCI Software — Source Intake
target_aos: AOS-0000, AOS-0011
claim:
evidence_level:
artifact:
limitations:
...
Packet #42, `AxonOS Article #42: Toward an Industry Standard for BCI Software — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #42
Source: standard/sources/medium/articles/42-*.md
Target AOS: AOS-0000, AOS-0011
Claim:
Evidence level:
