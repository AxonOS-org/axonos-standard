# Medium Source Packet #13: AxonOS Article #13: Claims Discipline for Neurotechnology — Source Intake
...
| Packet number | 13 |
| Working title | AxonOS Article #13: Claims Discipline for Neurotechnology — Source Intake |
...
For packet #13, the governing principle is that narrative claims must be
...
```text
source_packet: medium-13
source_title: AxonOS Article #13: Claims Discipline for Neurotechnology — Source Intake
target_aos: AOS-0003
claim:
evidence_level:
artifact:
...
Packet #13, `AxonOS Article #13: Claims Discipline for Neurotechnology — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #13
Source: standard/sources/medium/articles/13-*.md
Target AOS: AOS-0003
Claim:
Evidence level:
