# Medium Source Packet #31: AxonOS Article #31: AxonOS Reference Hardware — Source Intake
...
| Packet number | 31 |
| Working title | AxonOS Article #31: AxonOS Reference Hardware — Source Intake |
...
For packet #31, the governing principle is that narrative claims must be
...
```text
source_packet: medium-31
source_title: AxonOS Article #31: AxonOS Reference Hardware — Source Intake
...
Packet #31, `AxonOS Article #31: AxonOS Reference Hardware — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #31
Source: standard/sources/medium/articles/31-*.md
