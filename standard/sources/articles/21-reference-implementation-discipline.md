# Medium Source Packet #21: AxonOS Article #21: Reference Implementation Discipline — Source Intake
...
| Packet number | 21 |
| Working title | AxonOS Article #21: Reference Implementation Discipline — Source Intake |
| Normative status | Non-normative |
| Primary AOS route | AOS-0010, AOS-0011 |
...
For packet #21, the governing principle is that narrative claims must be
...
```text
source_packet: medium-21
source_title: AxonOS Article #21: Reference Implementation Discipline — Source Intake
target_aos: AOS-0010, AOS-0011
claim:
evidence_level:
artifact:
limitations:
...
Packet #21, `AxonOS Article #21: Reference Implementation Discipline — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #21
Source: standard/sources/medium/articles/21-*.md
Target AOS: AOS-0010, AOS-0011
Claim:
Evidence level:
