# Medium Source Packet #23: AxonOS Article #23: Shared Attention and Cognitive Cycles — Source Intake
...
| Packet number | 23 |
| Working title | AxonOS Article #23: Shared Attention and Cognitive Cycles — Source Intake |
| Normative status | Non-normative |
| Primary AOS route | AOS-0007, AOS-0008 |
...
For packet #23, the governing principle is that narrative claims must be
...
```text
source_packet: medium-23
source_title: AxonOS Article #23: Shared Attention and Cognitive Cycles — Source Intake
target_aos: AOS-0007, AOS-0008
claim:
evidence_level:
artifact:
limitations:
...
Packet #23, `AxonOS Article #23: Shared Attention and Cognitive Cycles — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #23
Source: standard/sources/medium/articles/23-*.md
Target AOS: AOS-0007, AOS-0008
Claim:
Evidence level:
