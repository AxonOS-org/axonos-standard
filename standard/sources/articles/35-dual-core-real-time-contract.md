# Medium Source Packet #35: The Dual-Core Real-Time Contract — Partitioned Scheduling Across Cortex-M4F and Cortex-A53
...
AOS mapping: AOS-0001, AOS-0003, AOS-0008.
...
| Packet number | 35 |
| Working title | The Dual-Core Real-Time Contract — Partitioned Scheduling Across Cortex-M4F and Cortex-A53 |
| Normative status | Non-normative |
| Primary AOS route | AOS-0001, AOS-0003, AOS-0008 |
...
For packet #35, the governing principle is that narrative claims must be
...
```text
source_packet: medium-35
source_title: The Dual-Core Real-Time Contract — Partitioned Scheduling Across Cortex-M4F and Cortex-A53
target_aos: AOS-0001, AOS-0003, AOS-0008
claim:
evidence_level:
artifact:
limitations:
...
Packet #35, `The Dual-Core Real-Time Contract — Partitioned Scheduling Across Cortex-M4F and Cortex-A53`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #35
Source: standard/sources/medium/articles/35-*.md
Target AOS: AOS-0001, AOS-0003, AOS-0008
Claim:
Evidence level:
