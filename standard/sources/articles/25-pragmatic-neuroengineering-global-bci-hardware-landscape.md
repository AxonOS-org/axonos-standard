# Medium Source Packet #25: Pragmatic Neuroengineering — The Global BCI Hardware Landscape
...
| Packet number | 25 |
| Working title | Pragmatic Neuroengineering — The Global BCI Hardware Landscape |
...
For packet #25, the governing principle is that narrative claims must be
...
```text
source_packet: medium-25
source_title: Pragmatic Neuroengineering — The Global BCI Hardware Landscape
...
Packet #25, `Pragmatic Neuroengineering — The Global BCI Hardware Landscape`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #25
Source: standard/sources/medium/articles/25-*.md
