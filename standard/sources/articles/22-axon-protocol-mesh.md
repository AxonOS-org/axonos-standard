# Medium Source Packet #22: AxonOS Article #22: Axon Protocol Mesh — Source Intake
...
| Packet number | 22 |
| Working title | AxonOS Article #22: Axon Protocol Mesh — Source Intake |
| Normative status | Non-normative |
| Primary AOS route | AOS-0008, AOS-0010 |
...
For packet #22, the governing principle is that narrative claims must be
...
```text
source_packet: medium-22
source_title: AxonOS Article #22: Axon Protocol Mesh — Source Intake
target_aos: AOS-0008, AOS-0010
claim:
evidence_level:
artifact:
limitations:
...
Packet #22, `AxonOS Article #22: Axon Protocol Mesh — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #22
Source: standard/sources/medium/articles/22-*.md
Target AOS: AOS-0008, AOS-0010
Claim:
Evidence level:
