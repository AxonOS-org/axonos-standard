# Medium Source Packet #11: AxonOS Article #11: Monotonic Time in Neural Systems — Source Intake
...
| Packet number | 11 |
| Working title | AxonOS Article #11: Monotonic Time in Neural Systems — Source Intake |
| Normative status | Non-normative |
| Primary AOS route | AOS-0003, AOS-0008 |
...
For packet #11, the governing principle is that narrative claims must be
...
```text
source_packet: medium-11
source_title: AxonOS Article #11: Monotonic Time in Neural Systems — Source Intake
target_aos: AOS-0003, AOS-0008
claim:
evidence_level:
artifact:
limitations:
...
Packet #11, `AxonOS Article #11: Monotonic Time in Neural Systems — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #11
Source: standard/sources/medium/articles/11-*.md
Target AOS: AOS-0003, AOS-0008
Claim:
Evidence level:
