# Medium Source Packet #27: AxonOS Article #27: Signal Quality Events — Source Intake
...
| Packet number | 27 |
| Working title | AxonOS Article #27: Signal Quality Events — Source Intake |
| Normative status | Non-normative |
| Primary AOS route | AOS-0007 |
...
For packet #27, the governing principle is that narrative claims must be
...
```text
source_packet: medium-27
source_title: AxonOS Article #27: Signal Quality Events — Source Intake
target_aos: AOS-0007
claim:
evidence_level:
artifact:
...
Packet #27, `AxonOS Article #27: Signal Quality Events — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #27
Source: standard/sources/medium/articles/27-*.md
Target AOS: AOS-0007
Claim:
Evidence level:
