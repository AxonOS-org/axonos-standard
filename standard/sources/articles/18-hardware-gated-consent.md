# Medium Source Packet #18: AxonOS Article #18: Hardware-Gated Consent — Source Intake
...
| Packet number | 18 |
| Working title | AxonOS Article #18: Hardware-Gated Consent — Source Intake |
...
For packet #18, the governing principle is that narrative claims must be
...
```text
source_packet: medium-18
source_title: AxonOS Article #18: Hardware-Gated Consent — Source Intake
...
Packet #18, `AxonOS Article #18: Hardware-Gated Consent — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #18
Source: standard/sources/medium/articles/18-*.md
