# Medium Source Packet #32: AxonOS Article #32: Microkernel Boundaries for Neural Software — Source Intake
...
| Packet number | 32 |
| Working title | AxonOS Article #32: Microkernel Boundaries for Neural Software — Source Intake |
| Normative status | Non-normative |
| Primary AOS route | AOS-0001, AOS-0008 |
...
For packet #32, the governing principle is that narrative claims must be
...
```text
source_packet: medium-32
source_title: AxonOS Article #32: Microkernel Boundaries for Neural Software — Source Intake
target_aos: AOS-0001, AOS-0008
claim:
evidence_level:
artifact:
limitations:
...
Packet #32, `AxonOS Article #32: Microkernel Boundaries for Neural Software — Source Intake`, is suitable for the AxonOS Standard repository as a
...
```text
Title: Extract standard claim from Medium packet #32
Source: standard/sources/medium/articles/32-*.md
Target AOS: AOS-0001, AOS-0008
Claim:
Evidence level:
