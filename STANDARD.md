...
**Version 1.0.0** — Canonical Technical Standard for Deterministic Brain-Computer Interface Software

**Status:** Normative · **Date:** 2026-05-21 · **License:** CC-BY-SA-4.0
...
A **regulator or safety engineer** assessing a device built on AxonOS should read Section 15 (consent), Section 22 (validation), the regulatory-positioning material in Section 30, and the companion `SECURITY.md`. Such a reader should understand clearly that this Standard is not a regulatory clearance and makes no claim of one; it is the substrate specification against which a regulatory submission could be drafted, which is a different and more modest thing.
